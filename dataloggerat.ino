...
int main(void)
{
   USART_init();  //Chamando a função USART_init
  
   while (1)      //Loop infinito que lê e envia os dados para a porta de comunicação
    {  
       ...
       _delay_ms(400);                //Delay de 400 milisegundos
